...
primary_topics:
  - GPCR Autoantibodies
  - Receptor Targeting
  - Pathogenic IgG Transfer
  - Autoantibody Landscapes
  - Antigen Profiling
...
Persistent post-infectious autoimmunity and the presence of functional autoantibodies represent a key biological model under investigation for Myalgic Encephalomyelitis/Chronic Fatigue Syndrome (ME/CFS) and Long COVID. In this model, initial infectious triggers are hypothesized to disturb immune homeostasis, potentially leading to the production of autoantibodies that target the nervous system, vascular tissues, and cellular receptors. Preclinical passive transfer experiments in mice demonstrate that purified Immunoglobulin G (IgG) from subsets of patients can replicate certain clinical symptoms—such as mechanical pain hypersensitivity and motor coordination deficits—and reduce small nerve fibers. However, these animal models and in vitro findings do not prove direct causality in humans, and the translation of these mechanisms to the complex clinical presentation of patients remains an active area of research.

A major focus of this research centers on autoantibodies targeting G-protein-coupled receptors (GPCRs), particularly adrenergic and muscarinic receptors. While early studies suggested a direct correlation between GPCR autoantibody levels and symptom severity, large-scale screenings reveal significant patient-to-patient heterogeneity, and some studies have failed to find consistent differences in GPCR autoantibody levels between patients and healthy controls. Furthermore, recent peer-reviewed data show that while beta-2 adrenergic autoantibody titers correlate with autonomic symptoms and sympathovagal imbalance, muscarinic autoantibody titers unexpectedly correlate with *better* cognitive performance in certain subsets, suggesting they may represent compensatory responses rather than simple drivers of disease. The lack of a single, universal autoantibody signature suggests that if autoimmune mechanisms are active, they operate through highly individualized profiles.

Clinical trials evaluating therapies that target autoantibodies—such as B-cell depleting agents, neonatal Fc receptor (FcRn) inhibitors, and immunoadsorption—have yielded mixed or negative outcomes, and no autoantibody-targeted treatment is currently established as effective. Although early observational studies of immunoadsorption and IVIG showed promise in clinical subsets, larger controlled trials of rituximab, efgartigimod, and BC007 failed to meet their primary endpoints. These mixed results highlight the high heterogeneity of the patient population and indicate that clearing autoantibodies is not a proven treatment path for the broader patient cohort. Further research and placebo-controlled trials using functional assays rather than simple titers are necessary to determine if specific, carefully stratified autoimmune sub-phenotypes can benefit from targeted immunomodulation.
...
- [Santos Guedes de Sá et al. 2024, medRxiv](https://doi.org/10.1101/2024.06.18.24309100)

### 2025-03-20 - High-throughput screening challenges GPCR autoantibodies as universal ME/CFS biomarkers
...
- [Germain et al. 2025, International Journal of Molecular Sciences](https://doi.org/10.3390/ijms26062799)

### 2025-04-15 - Clinical review highlights stratification needs in autoantibody-targeting trials
...
- [Wohlrab et al. 2025, Expert Opinion on Biological Therapy](https://doi.org/10.1080/14712598.2025.2492774)

### 2025-05-16 - Mast cell MRGPRX2 receptor identified as neuro-immune bridge for fibromyalgia IgG pain
...
- [Sanchez et al. 2025, bioRxiv](https://doi.org/10.1101/2025.05.15.652596)

### 2025-08-29 - Symposium report highlights GPCR autoantibodies as active cellular signaling modulators
...
- [Che et al. 2025, npj Metabolic Health and Disease](https://doi.org/10.1038/s44324-025-00079-w)

### 2025-11-20 - Passive transfer of Long COVID IgG induces pain by binding sensory neurons in dorsal root ganglia
...
### 2026-02-03 - Patient-derived IgG complexes induce mitochondrial fragmentation and metabolic stress
...
- [Liu et al. 2026, Brain, Behavior, & Immunity - Health](https://doi.org/10.1016/j.bbih.2026.101187)

### 2026-02-13 - Pilot study identifies GPCR autoantibody trends and low cortisol in severe Long COVID
...
- [Camici et al. 2026, International Journal of Molecular Sciences](https://doi.org/10.3390/ijms27041787)

### 2026-02-24 - Circulating GPCR autoantibodies correlate with functional vascular dysregulation
...
- [Seibert et al. 2026, PLOS ONE](https://doi.org/10.1371/journal.pone.0343264)

### 2026-03-22 - Large-scale cerebrospinal fluid screening reveals heterogeneous autoantibody profiles
...
- [Chakravarty et al. 2026, medRxiv](https://doi.org/10.1101/2026.03.19.26348833)

### 2026-05-05 - GPCR autoantibodies associate with autonomic imbalance and cognitive performance

A peer-reviewed observational case-control study of 96 post-COVID condition (PCC) patients, 59 ME/CFS patients, and 36 healthy controls analyzed plasma titers of adrenergic and muscarinic autoantibodies via ELISA. The study showed that ME/CFS patients have significantly higher beta-2 adrenergic receptor autoantibody titers, which correlate with sympathovagal imbalance and subjective autonomic symptoms. In contrast, higher titers of M1, M3, and M4 muscarinic autoantibodies unexpectedly correlated with better verbal and working memory in ME/CFS, suggesting a compensatory cholinergic response. However, because the study measured autoantibody titers via ELISA rather than functional assays, it did not determine whether the antibodies block or stimulate the targeted receptors, and the cross-sectional design prevents drawing causal conclusions. These findings support patient subtyping but highlight the need for functional assays and larger validation cohorts.

Sources:

- [Azcue et al. 2026, Scientific Reports](https://doi.org/10.1038/s41598-026-49131-9)

### 2026-05-07 - Conference presentation details autoantibody binding to brain cells

At the International ME/CFS Conference 2026 in Berlin, Germany, Dr. Marlen Alisch (ECRC Charité/MDC Berlin) presented in vitro research titled "Effects of Autoantibodies on Neuronal Function" demonstrating that serum IgG autoantibodies from a subset of post-COVID ME/CFS patients show increased binding to cultivated central nervous system (CNS) neurons. Furthermore, serum from all tested patients showed enhanced IgG binding to astrocytes, with binding intensity correlating with the severity of patients' neurological clinical symptoms. This suggests a potential biological mechanism for neuroinflammation and cognitive symptoms. However, as preliminary conference data, these findings have not yet undergone formal peer review. Additionally, in vitro studies of cultured cells do not account for blood-brain barrier dynamics, and further validation in larger, well-defined clinical cohorts is required.

Sources:

- [Alisch 2026, International ME/CFS Conference Presentation Video](https://youtu.be/G3_V-Dq6jKE)

### 2026-05-07 - Proteomics screening and animal model suggest pathogenic autoantibody activity

At the International ME/CFS Conference 2026 in Berlin, Germany, Dr. Keyla Sá (Yale University) presented a large-scale proteomics study titled "Analyse von Autoantikörpern bei Long COVID und ME/CFS" using Rapid Extracellular Antigen Profiling (REAP) to identify autoantibody targets. The study identified over 7,000 unique autoantibody targets in Long COVID patients that are absent in healthy controls, with significant overlap in ME/CFS, primarily targeting brain structures and blood vessels. Additionally, passive transfer of purified IgG autoantibodies from these patients into mice replicated patient-like symptoms, including increased pain sensitivity and a reduction in small nerve fibers. However, these findings represent preliminary conference data that have not undergone formal peer review. While animal models provide mechanistic insights, they may not fully capture the complex, systemic human pathophysiology of ME/CFS and Long COVID, and the clinical significance of these targets requires validation in larger cohorts.
