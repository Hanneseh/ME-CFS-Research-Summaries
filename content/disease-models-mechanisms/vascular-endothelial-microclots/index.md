...
primary_topics:
  ...
  - Circulating Microclots
  - Red Blood Cell Deformability
  - Fibrin Amyloid Fibrils
...
- [Haunhorst et al. 2024, Infection](https://doi.org/10.1007/s15010-024-02386-8)

### 2025-03-21 - Blood transcriptomics identify altered erythrocyte gene expression in male subgroup
...
- [Karisola et al. 2025, Frontiers in Immunology](https://doi.org/10.3389/fimmu.2025.1500997)

### 2025-04-01 - Thigh muscle biopsies reveal structural capillary narrowing and basement membrane thickening

A comparative analysis of skeletal muscle biopsies (_vastus lateralis_) from ME/CFS and Long COVID patients revealed severe structural pathology in the microvasculature. Under advanced microscopy, patient capillaries showed significantly thickened basement membranes and increased collagen IV deposition, resulting in a narrowed lumen radius. Furthermore, patients with ME/CFS exhibited a reduced capillary density (fewer capillaries per muscle fiber) compared to healthy controls, which correlated with impaired muscle oxygenation during exercise measured via near-infrared spectroscopy (NIRS). This provides direct physical evidence of anatomical barriers to oxygen diffusion and nutrient exchange within skeletal muscle tissue, explaining peripheral exertional intolerance. The findings do not prove the upstream mechanism driving the basement membrane thickening, nor do they demonstrate whether these structural capillary changes are reversible.

Sources:

- [Slaghekke et al. 2025, ME/CFS Research Foundation Poster](https://mecfs-research.org/wp-content/uploads/2025/04/Anouk-Slaghekke_Poster_Conference_2025.pdf)

### 2025-08-11 - Microfluidic velocity assays reveal impaired red blood cell response to low oxygen

An ex vivo study using capillary-mimicking microfluidic devices demonstrated that red blood cells (RBCs) from ME/CFS patients have an impaired velocity response to hypoxic stress. Unlike healthy RBCs, which speed up as oxygen tension ($PO_2$) decreases to maintain tissue perfusion, patient-derived RBCs showed a significantly reduced acceleration response. Measuring this dynamic "velocity slope" distinguished patients from controls with 77.8% accuracy and 90% specificity, demonstrating its potential as an objective diagnostic biomarker. Additionally, ex vivo treatment of patient RBCs with salmeterol xinafoate or xanomeline restored the velocity response to low oxygen. The study does not prove that these pharmaceutical agents will show safety or efficacy in clinical trials, nor does it establish the exact intracellular mechanism impairing RBC deformability and movement.

Sources:

- [Guo et al. 2025, blood RCI](https://doi.org/10.1016/j.brci.2025.100019)

### 2025-10-15 - Circulating microclots in Long COVID are stabilized by neutrophil extracellular traps
...
- [Thierry et al. 2025, Journal of Medical Virology](https://doi.org/10.1002/jmv.70613)

### 2025-11-26 - SARS-CoV-2 Spike protein fragments directly trigger lysis-resistant amyloid microclots
...
- [Westman et al. 2025, Biochemistry](https://doi.org/10.1021/acs.biochem.5c00550)

### 2025-12-25 - Soluble guanylate cyclase stimulation shows potential for treating chronic vascular dysfunction
...
- [Scheibenbogen et al. 2025, USPTO Patent](https://patents.google.com/patent/US20250387391A1/en)

### 2026-01-25 - Retinal vessel analysis documents systemic microvascular remodeling and endothelial dysfunction
...
- [Wallraven et al. 2026, medRxiv](https://doi.org/10.1101/2026.01.22.26344661)

### 2026-04-22 - Pediatric Long COVID study links microclots to Spike-induced neutrophil activation
...
- [Steifman et al. 2026, Pediatric Research](https://doi.org/10.1038/s41390-026-05024-1)

### 2026-05-07 - MIRACLE sub-study reports early capillary and orthostatic cerebral perfusion differences in ME/CFS
...
- [Sprenger 2026, International ME/CFS Conference video](https://youtu.be/eN-y_6MCpKw)

### 2026-05-07 - Extracellular-vesicle cargo study links endothelial hypoperfusion signals to symptom severity
...
- [Seifert 2026, International ME/CFS Conference video](https://youtu.be/Dkp956K3AvA)
...
- [Hyperbaric Oxygen Therapy](../../treatments-interventions/hyperbaric-oxygen-therapy/)
