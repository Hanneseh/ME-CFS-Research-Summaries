...
Genetic research into ME/CFS has moved from underpowered candidate-gene studies to large-scale, replicable findings. The DecodeME genome-wide association study—the largest ME/CFS genetic study to date, comparing 15,579 cases against 259,909 controls—identified eight genome-wide significant loci pointing to immune response genes (BTN2A2, OLFM4, RABGAP1L) and a neurological pain signal (CA10). Critically, the genetic risk profile did not overlap with depression or anxiety, providing objective biological evidence that distinguishes ME/CFS from psychiatric conditions. Complementary methods including Mendelian randomization, combinatorial analytics, epigenetic profiling, protein quantitative trait loci (pQTL) analysis, and whole-genome sequencing (WGS) have independently converged on immune dysregulation, neurological dysfunction, energy metabolism, and calcium signaling as biologically grounded disease pathways.

The picture emerging across studies is of a polygenic, highly heterogeneous condition in which both common variants with small individual effects and rare variants with large individual effects contribute to risk. Combinatorial analysis of the DecodeME cohort identified over 22,000 reproducible multi-SNP signatures across 2,311 unique genes, and WGS of 31 participants from 25 families found pathogenic or likely pathogenic variants in 39% of affected individuals—predominantly affecting ATP generation and oxidative phosphorylation. Salivary epigenetic profiling has also linked DNA hypomethylation of the *PTPRN2* gene body and associated mitochondrial inner membrane protein (PHB2) interactions to cognitive symptoms like brain fog, though in a small cohort. A meta-GWAS combining DecodeME and the Million Veteran Program (MVP) found significant enrichment in brain regions (cerebellum, frontal cortex) and glutamatergic synapse gene sets, whereas no peripheral tissue reached significance, pointing toward a central neurobiological dimension of risk. Recent work has expanded host genomic analysis to non-European admixed cohorts and identified peripheral whole-blood DNA methylation shifts at NMDA receptor genes linked to biological aging in post-COVID cohorts. Across all approaches, evidence is early; causal pathways are plausible but not yet clinically actionable, and findings in post-COVID or Long COVID cohorts require validation in strictly phenotyped ME/CFS populations with confirmed post-exertional malaise.
...
- **Plausible but early:** Peer-reviewed combinatorial multi-SNP signatures (neurological dysregulation, cellular stress, calcium signaling) are reproducible across independent patient subgroups within the DecodeME cohort and show genetic overlap with Long COVID. Rare monogenic variants in energy metabolism and synaptic signaling pathways are found in a substantial minority of affected families in small WGS studies. Mendelian randomization implicates mitochondrial DNA copy number and platelet characteristics as potential causal factors. Genetic variants affecting metabolite levels (HSD11B1, SCGN) suggest a partly heritable metabolic phenotype. Glutamatergic synapse enrichment in a two-dataset meta-GWAS converges with rare WGS variant signals in the same neuronal gene sets. Salivary epigenetic hypomethylation of the *PTPRN2* gene body and associated mitochondrial *PHB2* regulation correlate with cognitive symptom severity in small cohorts. Whole-blood DNA methylation alterations at NMDA receptor genes in post-COVID cohorts link glutamatergic pathway shifts and accelerated biological aging to cognitive sequelae. Exome-wide machine learning genetic association studies in admixed populations (e.g., Brazilian Long COVID cohorts) identify host risk signatures, extending genomic research into non-European populations.
- **Not established:** Causal genetic mechanisms sufficient to diagnose ME/CFS or predict treatment response. Replication of DecodeME GWAS hits in non-European or less strictly defined cohorts. Whether rare monogenic findings in small WGS cohorts generalise to the broader ME/CFS population. Clinical actionability of any identified genetic risk profile. Whether salivary or whole-blood epigenetic changes represent a primary causal mechanism or downstream disease consequence.
- **Key limitations:** Most historical GWAS datasets rely on European-ancestry samples, limiting generalisability, though initial exome-wide machine learning studies in admixed Brazilian cohorts begin addressing demographic gaps. UK Biobank cohorts used as controls or case sources depend on self-reported diagnoses, introducing misclassification risk. Small pQTL, WGS, and epigenetic cohorts require larger external validation. The DecodeME GWAS was not replicated in looser-phenotype biobanks, which the authors attribute to case-definition differences; this remains unresolved. Epigenetic findings are limited by small cohorts, cross-sectional design, and peripheral tissue sampling (saliva or whole blood vs. central nervous system tissue). Several recent genomic and epigenetic signatures derive from post-COVID/Long COVID cohorts without confirmed post-exertional malaise, necessitating cautious extrapolation to classic ME/CFS. Proprietary combinatorial analytics methods (PrecisionLife) may limit independent replication.
...
### 2026-04-20 - Epigenetic study links PTPRN2 hypomethylation and mitochondrial PHB2 to cognitive symptoms

An epigenetic study analyzing saliva samples from 54 ME/CFS patients and 21 sedentary healthy controls identified significant DNA hypomethylation at the CpG site cg19803194 within the *PTPRN2* gene body. This hypomethylation correlated with cognitive impairment ("brain fog") in both sexes and respiratory symptom severity in male patients. The epigenetic changes corresponded to reduced circulating levels of miR-153-3p, an intronic microRNA associated with memory recall. Researchers also demonstrated that Prohibitin 2 (PHB2), a mitochondrial inner membrane protein, interacts with and regulates the maturation of miR-153-3p, connecting mitochondrial biology to these epigenetic features. While providing a plausible molecular model for cognitive symptoms, the study is limited by its small cohort size and use of saliva rather than central nervous system tissue. Furthermore, this cross-sectional, observational design cannot determine whether these epigenetic alterations are a cause or a consequence of the illness.

Sources:

- [Journal of Translational Medicine 2026](https://pubmed.ncbi.nlm.nih.gov/42010606)

### 2026-04-21 - Peer-reviewed DecodeME combinatorial analysis identifies 22,411 disease signatures and Long COVID overlap

A genomic association study using combinatorial analytics (PrecisionLife platform) analyzed genetic data from the DecodeME cohort compared to UK Biobank controls and was published in peer-reviewed format. The study identified 22,411 reproducible combinatorial disease signatures (multi-SNP genotypes of 1–4 SNPs) involving 7,555 unique SNPs across 2,311 genes associated with ME/CFS susceptibility. It highlighted 259 "core genes" enriched in ME/CFS patients that map to neurological dysregulation, cellular stress, and calcium signaling pathways. The analysis also demonstrated genetic overlap with Long COVID, finding that 76 associated genes were shared between the cohorts. Although this combinatorial approach offers higher sensitivity than single-variant GWAS, it relies on a proprietary methodology that limits independent replication. Furthermore, the use of external UK Biobank controls introduces potential population stratification biases, and these genetic associations do not establish causal biological mechanisms without functional validation.

Sources:

- [PubMed 2026](https://pubmed.ncbi.nlm.nih.gov/42015188)
...
### 2026-07-20 - Epigenetic study links whole-blood NMDA receptor gene methylation and biological aging to post-COVID cognitive symptoms

An epigenetic investigation published in PubMed Central analyzed whole-blood DNA methylation profiles in post-COVID patients, identifying significant methylation alterations at core N-methyl-D-aspartate (NMDA) receptor gene loci. These epigenetic shifts in glutamatergic signaling pathways correlated with accelerated biological aging measured by epigenetic clocks and were associated with Long COVID neuropsychiatric sequelae and cognitive dysfunction ("brain fog"). The findings provide a peripheral epigenetic model linking post-viral immune-inflammatory signaling to glutamatergic gene regulation and cognitive impairment. However, the study relies on cross-sectional whole-blood samples rather than central nervous system tissue, and peripheral methylation markers do not prove direct central glutamatergic pathology. Additionally, the cohort focused on post-COVID syndrome rather than strictly phenotyped ME/CFS with post-exertional malaise, requiring prospective validation in classic ME/CFS populations.

Sources:

- [PubMed Central 2026](https://pmc.ncbi.nlm.nih.gov/articles/PMC13380026/)

### 2026-08-01 - Exome-wide machine learning study identifies host genetic risk signatures for Long COVID in an admixed Brazilian cohort

An exploratory exome-wide machine learning study published in Frontiers in Medicine analyzed host genomic variants in a large, diverse admixed Brazilian cohort to identify genetic susceptibility signatures associated with Long COVID. By applying machine learning classification across exome sequencing data, researchers identified candidate host gene panels associated with post-viral sequelae, extending genetic association research beyond European-ancestry populations. The inclusion of highly admixed cohorts addresses a major geographic and demographic bias in post-infectious genomic literature. However, the study relies on exploratory machine learning algorithms that require independent replication in separate multi-ethnic cohorts. Furthermore, the dataset was derived from Long COVID patients rather than strictly phenotyped ME/CFS cohorts with confirmed post-exertional malaise, so the degree to which these host genetic signatures overlap with classic ME/CFS remains unproven.
...
- Are host genetic signatures identified in admixed Long COVID cohorts replicated in strictly phenotyped ME/CFS cohorts across diverse ancestral backgrounds?
- Do peripheral whole-blood DNA methylation alterations at NMDA receptor genes correlate with central nervous system glutamatergic dysregulation or neuroinflammation in post-viral illness?
