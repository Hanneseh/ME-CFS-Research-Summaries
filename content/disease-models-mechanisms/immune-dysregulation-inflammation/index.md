...
primary_topics:
  ...
  - Cytokine Profiles & Systemic Inflammation
  - Monocyte & Dendritic Cell Remodeling
  - HLA Risk Associations
...
- [Gil et al. 2023, Brain, Behavior, & Immunity - Health](https://doi.org/10.1016/j.bbih.2023.100720)

### 2024-02-21 - Landmark NIH deep-phenotyping study links post-infectious ME/CFS to chronic immune activation and neuro-immune dysfunction
...
- [Walitt et al. 2024, Nature Communications](https://doi.org/10.1038/s41467-024-45107-3)

### 2024-04-08 - Longitudinal N-of-1 profiling of severe ME/CFS associates symptom severity with Th2-type cytokine profiles
...
- [Jahanbani et al. 2024, Frontiers in Immunology](https://doi.org/10.3389/fimmu.2024.1369295)

### 2024-10-22 - Transcriptional profiling distinguishes immune suppression in ME/CFS from hyper-activation in Long COVID
...
- [Eaton-Fitch et al. 2024, JCI Insight](https://pmc.ncbi.nlm.nih.gov/articles/PMC11529985/)

### 2025-09-08 - Persistent NLRP3 inflammasome activation correlates with neuropsychiatric and fatigue symptoms in Long COVID

Serum analysis of 161 Long COVID patients assessed 6 to 9 months post-infection demonstrated that levels of NLRP3, caspase-1, IL-1β, and IL-18 were significantly elevated in patients who experienced severe acute illness. These elevated inflammasome markers correlated strongly with chronic fatigue and neuropsychiatric symptom severity, with acute oxygen desaturation ($SpO_2$) serving as a strong predictor of chronic NLRP3 activity. This identifies the NLRP3 inflammasome pathway as a persistent driver of systemic inflammation in Long COVID, providing a rational target for clinical trials evaluating NLRP3 inhibitors. However, the observational, case-control design cannot establish a causal link showing that NLRP3 activation directly drives neuropsychiatric symptoms, and replication in independent cohorts is needed.

Sources:

- [Zhang et al. 2025, medRxiv](https://doi.org/10.1101/2025.09.07.25335261)

### 2025-10-24 - Computational model links ME/CFS susceptibility HLA alleles to weak binding of post-viral pathogens

An in silico binding study of HLA alleles associated with ME/CFS risk (C*07:04 and DQB1*03:03) and protection (B*08:01 and DPB1*02:01) demonstrated that risk alleles bind herpesvirus (HHV), SARS-CoV-2, and _Borrelia burgdorferi_ proteins with significantly weaker affinity compared to protective alleles. This provides a potential immunogenetic explanation for post-infectious syndromes, suggesting that an inadequate HLA makeup leads to poor antigen clearance, persistent viral/bacterial presence, and chronic immune activation. However, these in silico predictions require biological validation in live patient cohorts to confirm that weak HLA binding corresponds to antigen persistence in tissues.

Sources:

- [Georgopoulos et al. 2025, Scientific Reports](https://doi.org/10.1038/s41598-025-21230-z)

### 2025-11-07 - Retrospective cohort study establishes mast cell activation as a frequent and treatable comorbidity in ME/CFS
...
- [Rohrhofer et al. 2025, Diagnostics](https://doi.org/10.3390/diagnostics15222828)

### 2025-11-18 - Multi-omics profiling identifies profound sex-specific immune and endocrine dysregulation in Long COVID
...
- [Shahbaz et al. 2025, Cell Reports Medicine](https://doi.org/10.1016/j.xcrm.2025.102449)

### 2025-11-20 - Single-cell epigenomics reveals NF-κB priming in a distinct monocyte subset driving post-exertional inflammation
...
- [Iu et al. 2025, The Journal of Immunology](https://doi.org/10.1093/jimmun/vkaf283.2434)

### 2025-11-25 - Mechanistic review outlines mTOR hyperactivation axis linking infections to neuroinflammation
...
- [Fronticelli Baldelli & Buonsenso 2025, MDPI Children](https://doi.org/10.3390/children12121603)

### 2025-12-05 - Large-scale cohort study confirms persistent CD8+ T-cell depletion 20 months post-COVID-19
...
- [Jiang et al. 2025, International Journal of Infectious Diseases](https://doi.org/10.1016/j.ijid.2025.108287)

### 2025-12-08 - Comparative analysis reveals identical lymphocyte and cytokine profiles in ME/CFS and Long COVID
...
- [Petrov et al. 2025, Biomedicines](https://doi.org/10.3390/biomedicines13123001)

### 2025-12-10 - Cytotoxic cell immunosenescence and activation signatures differentiate ME/CFS severity subgroups
...
- [Lee et al. 2025, Journal of Translational Medicine](https://doi.org/10.1186/s12967-025-07507-x)

### 2025-12-12 - Multi-omics analysis detects persistent JAK-STAT pathway activation in Long COVID
...
- [Aid et al. 2025, Nature Immunology](https://doi.org/10.1038/s41590-025-02353-x)

### 2026-01-09 - Endothelial senescence framework links immune clearance failure to chronic tissue perfusion deficits

A theoretical model proposed that virus-induced endothelial senescence ("zombie cells") is a primary driver of ME/CFS and Long COVID. In this model, impaired immune clearance allows senescent cells to persist and release SASP factors, promoting microvascular clotting and restricting regional blood flow. This provides a mechanistic bridge connecting cellular immune dysfunction (impaired NK and CD8+ T cell cytotoxicity) to vascular perfusion deficits, explaining symptoms like post-exertional malaise and brain fog. However, as a theoretical framework, this model requires empirical validation in clinical cohorts using specific senescent endothelial cell biomarkers.

Sources:

- [Nunes et al. 2026, Cell Death & Disease](https://doi.org/10.1038/s41419-025-08162-2)

### 2026-02-02 - Sleep disturbance in Long COVID associated with impaired lipid-mediated inflammatory resolution
...
- [Engert et al. 2026, Prostaglandins, Leukotrienes and Essential Fatty Acids](https://doi.org/10.1016/j.plefa.2026.102728)

### 2026-02-23 - Plasma proteomic profiling reveals stable, spike-protein-independent inflammatory state in late PASC
...
- [Fineschi et al. 2026, Frontiers in Immunology](https://doi.org/10.3389/fimmu.2026.1775044)

### 2026-02-25 - Single-cell RNA sequencing maps Galectin-9–TIM-3-driven T-cell depletion in Long COVID
...
- [Shahbaz et al. 2026, Frontiers in Immunology](https://doi.org/10.3389/fimmu.2026.1745933)

### 2026-03-01 - Innate immune review highlights persistent macrophage activation and failed resolution in PASC
...
- [Petrov et al. 2026, medRxiv](https://www.medrxiv.org/content/10.1101/2026.04.12.26350613)

### 2026-04-28 - Antigen-discovery project targets the proteins driving dysfunctional T cells
...
- [Selin et al. 2026, Solve ME/CFS Initiative](https://youtu.be/-g3Zz8DwK_c)

### 2026-05-08 - MIRACLE study identifies reduced mtDNA copy numbers and altered HDL function in ME/CFS
...
- [Schieffer et al. 2026, International ME/CFS Conference 2026](https://events.mecfs-research.org/en/events/conference_2026/agenda)

### 2026-06-05 - Clinical and in vitro study associates elevated IL-11 and MMP-9 with EBV-induced mast cell activation
...
- [Chinnappan et al. 2026, Frontiers in Immunology](https://doi.org/10.3389/fimmu.2026.1827700)

### 2026-06-08 - Single-cell RNA sequencing maps coordinated B-cell, monocyte, T-cell, and NK-cell dysregulation in Long COVID
...
- [Satpathy et al. 2026, bioRxiv](https://doi.org/10.64898/2026.06.04.730206)

### 2026-06-28 - Glycosylation study suggests immune and red-blood-cell desialylation changes in ME/CFS and Long COVID
